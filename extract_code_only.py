...
# Load full structured JSON
with open("results/json1.json", "r", encoding="utf-8") as f:
...
with open("results/dwr_output.txt", "w", encoding="utf-8") as f:
    # Write top metadata
...
print("Full DWR with metadata and parameters saved to dwr_output.txt")
